...
export const FileToUploadCard: FunctionComponent<FileToUploadCardProps> = ({
  ...
  return (
    <div className="flex w-[100%] items-center gap-2 p-2 hover:backdrop-brightness-95 min-h-[4rem] border border-dashed bg-neutral-200 rounded-lg">
      ...
      <div className="flex items-center justify-between w-[90%]">
        <div className="w-[80%]">
          ...
          <p className="text-sm font-medium text-emerald-500 dark:text-zinc-500">{convertSize(file?.size)}</p>
        </div>
      </div>
