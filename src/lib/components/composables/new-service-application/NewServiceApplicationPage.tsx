...
const stepItems = [
  ...
  },
  {
    ...
    step: 2,
    tooltip: 'Fill-in Applicant Information',
  },
    ...
    <PageContext.Provider value={{ pageRef }}>
      <div className="w-full relative h-[100vh] bg-sky-300 overflow-y-auto" ref={pageRef}>
        <div className=" w-full h-[100vh] absolute ">
          <div className="fixed top-0 left-2 w-[80%] h-[calc(100vw*0.5)]  bg-sky-400 rounded-full blur-3xl filter opacity-70  mix-bl mix-blend-multiply" />
        ...
        <div className="w-full relative h-fit sm:py-0 lg:py-10 gap-0  flex justify-center">
          <section className="bg-white  h-fit rounded border w-full sm:mx-0 lg:mx-[20%] p-16 shadow-lg">
            <div className="w-full flex justify-center items-center flex-col pb-8">
              <img
                ...
                decoding="async"
              />
              <p className="text-2xl font-medium font-sans">General Santos City Water District</p>
            </div>
            <div className=" ">
